...
export const getBuildUrl = (params?: BuildParams) => {
  ...
  return `/web-ide/project/build?${normalizedParams.toString()}`;
};
...
export const getDeleteProjectUrl = (params?: DeleteProjectParams) => {
  ...
  return `/web-ide/project?${normalizedParams.toString()}`;
};
...
export const getDeployProjectsUrl = (params?: DeployProjectsParams) => {
  ...
  return `/web-ide/project/deploy?${normalizedParams.toString()}`;
};
...
export const getInitProjectUrl = (params?: InitProjectParams) => {
  ...
  return `/web-ide/project/init?${normalizedParams.toString()}`;
};
...
export const getWatchUrl = (params?: WatchParams) => {
  ...
  return `/web-ide/project/watch?${normalizedParams.toString()}`;
};
...
export const deleteWorkspace = async (deleteWorkspaceBody: string, options?: RequestInit): Promise<deleteWorkspaceResponse> => {
  return customFetch<Promise<deleteWorkspaceResponse>>(getDeleteWorkspaceUrl(), {
    ...options,
    method: 'DELETE',
