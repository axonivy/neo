...
export type FindBestMatchProductDetailsByVersionParams = {
  /**
   * Option to get Dev Version (Snapshot/ sprint release)
   */
  isShowDevVersion?: boolean;
...
export const getFindBestMatchProductDetailsByVersionUrl = (
  id: string,
  version: string,
  params?: FindBestMatchProductDetailsByVersionParams
) => {
  const normalizedParams = new URLSearchParams();
  ...
  return stringifiedParams.length > 0
    ? `/api/product-details/${id}/${version}/bestmatch?${stringifiedParams}`
    : `/api/product-details/${id}/${version}/bestmatch`;
};

/**
 * Get best match version by product id and version
 * @summary Find best match version of a product by product id and version.
 */
export const findBestMatchProductDetailsByVersion = async (
  ...
  return customFetch<findBestMatchProductDetailsByVersionResponse>(getFindBestMatchProductDetailsByVersionUrl(id, version, params), {
    ...options,
    method: 'GET'
  });
};
 ...
 */
export const findImageById = async (id: string, options?: Parameters<typeof customFetch>[1]): Promise<findImageByIdResponse> => {
