...
export type FindAllFeedbacksParams = {
isFocused?: boolean;
/**
...
size?: number;
/**
 * Sorting metadata: Criteria(popularity|alphabetically|recent), Order(asc|desc)
 */
sort: string[];
};
...
export const findFeedbackByUserIdAndProductId = async (params: FindFeedbackByUserIdAndProductIdParams, options?: RequestInit): Promise<findFeedbackByUserIdAndProductIdResponse> => {
...
export const createFeedback = async (feedbackModelRequest: FeedbackModelRequest, options?: RequestInit): Promise<createFeedbackResponse> => {
...
/**
 * Get installation count by product id.
 * @summary Get installation count by product id.
 */
...
export const findGithubPublicReleaseByProductIdAndReleaseId = async (productId: string,
  ...
  return customFetch<findGithubPublicReleaseByProductIdAndReleaseIdResponse>(getFindGithubPublicReleaseByProductIdAndReleaseIdUrl(productId,releaseId),
  {      
    ...options,
    method: 'GET'
...
export const findBestMatchVersion = async (id: string,
  ...
  return customFetch<findBestMatchVersionResponse>(getFindBestMatchVersionUrl(id,version,params),
  {      
    ...options,
    method: 'GET'
...
export const getProductDesignerInstallationByProductId = async (id: string, options?: RequestInit): Promise<getProductDesignerInstallationByProductIdResponse> => {
...
/**
 * Fetches the test report associated with the specified product ID and workflow type.
 * @summary Get test report for a product and workflow
 */
...
export type getTestReportResponseSuccess = (getTestReportResponse200) & {
  headers: Headers;
};
;

export type getTestReportResponse = (getTestReportResponseSuccess)

export const getGetTestReportUrl = (productId: string,
    workflow: 'CI' | 'DEV' | 'E2E',) => {


  

  return `/api/monitor-dashboard/${productId}/${workflow}`
}

export const getTestReport = async (productId: string,
    workflow: 'CI' | 'DEV' | 'E2E', options?: RequestInit): Promise<getTestReportResponse> => {
  
  return customFetch<getTestReportResponse>(getGetTestReportUrl(productId,workflow),
  {      
    ...options,
    method: 'GET'
...
/**
 * Fetches all GitHub repositories with optional filtering, searching, and sorting capabilities.
 * @summary Get all GitHub repositories
 */
export type findAllFeedbacksResponse200 = {
  data: PagedModelGithubReposModel
  status: 200
}
    
export type findAllFeedbacksResponseSuccess = (findAllFeedbacksResponse200) & {
  headers: Headers;
};
;

export type findAllFeedbacksResponse = (findAllFeedbacksResponseSuccess)

export const getFindAllFeedbacksUrl = (params?: FindAllFeedbacksParams,) => {
  const normalizedParams = new URLSearchParams();
  ...
  return stringifiedParams.length > 0 ? `/api/monitor-dashboard/repos?${stringifiedParams}` : `/api/monitor-dashboard/repos`
}

export const findAllFeedbacks = async (params?: FindAllFeedbacksParams, options?: RequestInit): Promise<findAllFeedbacksResponse> => {
  
  return customFetch<findAllFeedbacksResponse>(getFindAllFeedbacksUrl(params),
  {      
    ...options,
    method: 'GET'
...
export const getFindFeedbacksUrl = (id: string,
...
export const findFeedbacks = async (id: string,
    params: FindFeedbacksParams, options?: RequestInit): Promise<findFeedbacksResponse> => {
...
/**
 * Finds the external document metadata for the given product id and version.
 * @summary Find external document by product id and version
 */
...
export const getFindExternalDocumentUrl = (id: string,
    version: string,) => {
...
export const findExternalDocument = async (id: string,
    version: string, options?: RequestInit): Promise<findExternalDocumentResponse> => {
...
/**
 * Redirects to the best matching external document version based on the provided path parameter.
 * @summary Redirect to the best matching external document version
 */
...
export const redirectToBestVersion = async (params?: RedirectToBestVersionParams, options?: RequestInit): Promise<redirectToBestVersionResponse> => {
...
/**
 * Retrieve document information based on the specified artifact, version, and language.
 * @summary Get document info by artifact, version and language
 */
...
export const getGetDocumentByVersionAndLanguageUrl = (artifact: string,
    version: string,
    language: string,) => {
...
export const getDocumentByVersionAndLanguage = async (artifact: string,
    version: string,
    language: string, options?: RequestInit): Promise<getDocumentByVersionAndLanguageResponse> => {
