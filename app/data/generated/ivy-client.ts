...
export const readConfig = async (params?: ReadConfigParams, options?: Parameters<typeof customFetch>[1]): Promise<readConfigResponse> => {
...
export const dataClasses = async (options?: Parameters<typeof customFetch>[1]): Promise<dataClassesResponse> => {
...
export const projects = async (options?: Parameters<typeof customFetch>[1]): Promise<projectsResponse> => {
...
export const findOrCreatePmv = async (
  projectParams?: ProjectParams,
  options?: Parameters<typeof customFetch>[1]
): Promise<findOrCreatePmvResponse> => {
  const getHeaders = (h?: NonNullable<RequestInit['headers']>): Record<string, string | readonly string[]> => {
    if (!h) return {};
    if (h instanceof Headers) return Object.fromEntries(h.entries());
    if (Symbol.iterator in h) {
