...
export const getInvalidateClassLoaderUrl = (params?: InvalidateClassLoaderParams,) => {
  ...
  return stringifiedParams.length > 0 ? `/web-ide/project/invalidate-class-loader?${stringifiedParams}` : `/web-ide/project/invalidate-class-loader`
}

export const invalidateClassLoader = async (params?: InvalidateClassLoaderParams, options?: RequestInit): Promise<invalidateClassLoaderResponse> => {
